...
import { Heart, MessageCircle, Share2, Image as ImageIcon, Gamepad2 } from "lucide-react"
...
export default function FeedPage() {
  ...
  return (
    <div className="min-h-screen bg-background pixel-stars scanlines">
      <Navigation notificationCount={3} isLoggedIn={true} />
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h2 className="pixel-title text-xs gradient-text">SEU FEED</h2>
